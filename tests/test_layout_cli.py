...
class LayoutCliTests(unittest.TestCase):
    ...
    def test_default_hides_fee_presentation_but_retains_evidence(self):
        ...
        self.assertEqual(state["graph_options"], {"include_fees": False, "color_attribution_arrows": False})
        self.assertEqual(graph["graph_options"], {"include_fees": False, "color_attribution_arrows": False})
